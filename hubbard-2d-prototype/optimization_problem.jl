...
open(full_output_name, "a") do file
    println(file, "Optimization variables created.")
end
...
if no_geometric_symmetry
    ...
    all_constraints = [
        ...
        translational_x_constraint_coefficients..., 
        translational_y_constraint_coefficients...,
...
open(full_output_name, "a") do file
    println(file, "Equational constraint added.")
end
